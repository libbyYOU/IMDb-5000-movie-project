...
```
```{r}
keywords.lasso.coef=predict(lasso.mod,type="coefficients",s=lasso.best.lam)[1:24,]
...
```{r}
directors.lasso.coef=predict(lasso.mod,type="coefficients",s=lasso.best.lam)[1:24,]
