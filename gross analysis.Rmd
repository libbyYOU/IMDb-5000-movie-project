...
```{r}
data1=dplyr::select(movie2,gross,budget,duration,title_year,director_facebook_likes, imdb_score, actor_1_facebook_likes, actor_2_facebook_likes,actor_3_facebook_likes, cast_total_facebook_likes, movie_facebook_likes, num_voted_users, num_critic_for_reviews, facenumber_in_poster)
...
```{r}
write.csv(actors.lasso.co,file = "actors_gross")
write.csv(directors.co,file = "directors_gross")
write.csv(genres.co,file = "genres_gross")
write.csv(keywords.co,file = "keywords_gross")
```
