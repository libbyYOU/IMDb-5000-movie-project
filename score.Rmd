...
actors_matrix[,i] =actors_matrix[,i] + 
  str_detect(movie$actor_1_name,pattern = as.character(keywords[i,1]))  +
  str_detect(movie$actor_2_name,pattern = as.character(keywords[i,1])) +
  str_detect(movie$actor_3_name,pattern = as.character(keywords[i,1])) 
}
