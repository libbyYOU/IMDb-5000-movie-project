...
```
```{r}
write.csv(actors.coef,file = "actors_score")
write.csv(keywords.coef,file = "keywords_score")
write.csv(directors.coef,file = "directors_score")
write.csv(genres.coef,file = "genres_score")
```
